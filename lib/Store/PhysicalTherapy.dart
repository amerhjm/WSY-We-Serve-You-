...
import 'package:wsy/Store/bodyCare.dart';
...
class PhysicalTherapy extends StatefulWidget {
  @override
  _PhysicalTherapy createState() => _PhysicalTherapy();
}

class _PhysicalTherapy extends State<PhysicalTherapy> {
              ...
              slivers: [
                ...
                StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      ...
                      .where("serviceCategory", isEqualTo: "Spa")
                      .snapshots(),
    ...
    slivers: [
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .limit(15)
            .orderBy("publishedDate", descending: true)
            .where("serviceCategory", isEqualTo: "PhysicalTherapy")
            .snapshots(),
        builder: (context, dataSnapshot) {
          return !dataSnapshot.hasData
              ? SliverToBoxAdapter(
